...
<pre>
cd ~
wget  http://cloud.github.com/downloads/cogentsoft/zbs/freetds-stable.tgz
...
<pre>
cd ~
wget http://cloud.github.com/downloads/cogentsoft/zbs/ruby-odbc-0.9996.tar.gz
...
<pre>
#配置企业信息号,短信机系统标识
#或者配置短信内容模板http://cloud.github.com/downloads/cogentsoft/zbs/sphinx-0.9.8-rc2.tar.gz

...
cd ~
#instance client必须
wget http://cloud.github.com/downloads/cogentsoft/zbs/oracle-instantclient-basic_10.2.0.3-2_i386.deb
sudo dpkg -i oracle-instantclient-basic_10.2.0.3-2_i386.deb
wget http://cloud.github.com/downloads/cogentsoft/zbs/oracle-instantclient-devel_10.2.0.3-2_i386.deb
sudo dpkg -i oracle-instantclient-devel_10.2.0.3-2_i386.deb
#非必须，sqlplus用于调试是否能正常连接
wget http://cloud.github.com/downloads/cogentsoft/zbs/oracle-instantclient-sqlplus_10.2.0.3-2_i386.deb
...
#安装rails数据库适配器
sudo gem install activerecord-oracle_enhanced-adapter --no-ri --no-rdoc

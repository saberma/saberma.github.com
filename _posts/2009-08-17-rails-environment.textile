...
sudo gem install rspec hoe haml thoughtbot-paperclip mislav-will_paginate mysql mongrel mongrel_cluster aslakhellesoy-cucumber webrat whenever ferret acts_as_ferret rmmseg system-timer --no-ri --no-rdoc

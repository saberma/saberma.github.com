...
title: 全文检索Sphinx
---
"参考全文检索Ferret":http://wiki.github.com/cogentsoft/zbs/ferret
以下内容不再使用
...
cd ~
wget http://cloud.github.com/downloads/cogentsoft/zbs/mmseg-0.7.3.tar.gz
...
#"下载sphinx"
cd ~
wget http://cloud.github.com/downloads/cogentsoft/zbs/sphinx-0.9.8-rc2.tar.gz
